 ...
 */
$host = "database-1.crpvidwhjdlz.eu-west-3.rds.amazonaws.com";                                    // MySQL host name eg. localhost
$user = "admin";                                         // MySQL user. eg. root
$password = "M781227salma*";                                         // MySQL user password 
$database = "database-1";                                 // MySQL Database name
